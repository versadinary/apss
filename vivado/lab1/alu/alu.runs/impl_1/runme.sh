...
HD_PWD='E:/lab1/alu/alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_adder.tcl -notrace

...
HD_PWD='E:/lab2/ram_rom_programming/ram_rom_programming.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_CYBERcobra.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys_CYBERcobra.tcl

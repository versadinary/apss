...
HD_PWD='E:/lab2/ram_rom_programming/ram_rom_programming.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_CYBERcobra.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_CYBERcobra.tcl -notrace
